...
alias startvpn='bash ~/.scripts/vpn.bash'
...
function tor() {
    echo 'starting tor'
    # bash -c "gnome-terminal --hide-menubar --geometry 150x100 -t 'TOR' -- /home/gml/tor/src/app/tor"
    gnome-terminal --hide-menubar --geometry 75x30 -t 'Tor' -- /home/gml/tor/src/app/tor
}
